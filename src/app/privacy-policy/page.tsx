...
const Privacy_Policy = () => {
  return (
    <section className="content custom-container mb-12 md:my-28 mt-20 md:mt-40 lg:mr-32">
      <h3 className="font-bold text-5xl mb-8">Privacy Policy of rampUp</h3>
      <div className="flex justify-between items-start text-2xl">
        <div>
          <p className="mb-12 font-light">
            ...
            <br />
            Owner and Data Controller 2nd Innings Technology Pvt. Ltd. -
            Gurgaon, Haryana <br />
            Owner contact email: social@ramp-up.in
          </p>

          <div>
            <h3 className="text-3xl my-4">Types of data collected</h3>
            <p className="mb-8 font-light">
              Among the types of Personal Data that this Application collects,
              by itself or through third parties, there are: Usage Data; first
              name; email address; username; password; profile picture; last
              name. Complete details on each type of Personal Data collected are
          ...
          <div>
            <h3 className="text-3xl my-4">Legal basis of processing</h3>
            <p className="mb-2 font-light">
              The Owner may process Personal Data relating to Users if one of
              the following applies: Users have given their consent for one or
              more specific purposes. Note: Under some legislations the Owner
              may be allowed to process Personal Data until the User objects to
              such processing (“opt-out”), without having to rely on consent or
              any other of the following legal bases. This, however, does not
              ...
              which the Owner is subject; processing is related to a task that
              ...
              processing of Personal Data. Users are also entitled to learn
              about the legal basis of Data transfers to a country outside India
              or to any international organization governed by public
              international law or set up by two or more countries, such as the
              UN, and about the security measures taken by the Owner to
              ...
              such contract has been fully performed. Personal Data collected
              for the purposes of the Owner’s legitimate interests shall be
              retained as long as needed to fulfill such purposes. Users may
              find specific information regarding the legitimate interests
              ...
              after expiration of the retention period. <br />
              ...
              activity, as well as the following: Platform services and hosting,
              Registration and authentication and Managing contacts and sending
              messages.
              <br />
            ...
            <ul className="font-light">
              ...
              <li>Place of processing: India – Privacy Policy.</li>
              <li>
                Category of personal data collected according to CCPA:
                identifiers.
              </li>
              <li>
                This processing constitutes a sale based on the definition under
                the CCPA. In addition to the information in this clause, the
                User can find information regarding how to opt out of the sale
                in the section detailing the rights of Indian consumers.
              </li>
              ...
              <li>
                ...
                of this Application from within a unified platform. Such
                platforms provide a wide range of tools to the Owner – e.g.
                analytics, user registration, commenting, database management,
                e-commerce, payment processing – that imply the collection and
              ...
              <li>
                ...
                where the Personal Data are stored. Apple App Store (Apple Inc.)
                This Application is distributed on Apple's App Store, a platform
                for the distribution of mobile apps, ...
              </li>
            </ul>
          </div>
        </div>
